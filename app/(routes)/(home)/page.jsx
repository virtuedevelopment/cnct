        ...
        <header className={styles.header}>
          <div className={styles.about}>
            ...
            <p>
              ...
              things often feel automated, transactional, and impersonal, we
              bring it back to what truly matters — people.
            </p>
      ...
      <main className="main">
        <section className={styles.portfolio}>
          ...
          <p>
            ...
            and markets. Our portfolio reflects the thoughtful strategy,
            creative precision, and long-term vision we bring to every
            collaboration.
          </p>
          ...
          <div className={styles.description}>
            ...
            <span>
              <p className={styles.txt}>
                ...
                trip recaps, this is where we share what moves us. It’s our way
                of flexing our storytelling muscles and keeping the site fresh,
